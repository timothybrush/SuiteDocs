...
{{% notice tip %}}The template editor used for creating and editing email templates can be selected in the link:../../getting-started/managing-your-profile/#_personal_email_account_settings[user profile email settings]. The default setting (Mozaik) is shown in the following screen shots. {{% /notice %}}
...
link:../targets[Lead], link:../../sales-relationships/contacts/[Contact] or link:../targets[Target] record in *SuiteCRM*
