...
По умолчанию фильтровать записи можно в субпанели link:../../../../../user/core-concepts/views/#_мероприятия[ИСТОРИЯ^], что может быть удобно для быстрого нахождения необходимой информации в случае большого количества записей.
...
link:../../../../../user/core-concepts/searching/#_расширенный_фильтр[Расширенного фильтра^].
