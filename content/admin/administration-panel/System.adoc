...
See the link:../../../user/core-concepts/record-management/#_importing_records[Importing Records]
...
See the User Interface guide to the link:../../../user/core-concepts/searching/[global search] 
...
Please see the link:../../../user/core-concepts/homepage-dashboards/#_activity_stream[user interface guide] for 
